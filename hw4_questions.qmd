...
**Observations:** Marketing Analytics (MGTA 495) stands out as the clear top preference, with a large positive counts score. Customer Analytics (MGTA 455) and Large Data (MGTA 452) also rank highly. At the bottom, Analytics Consulting (MGTA 444) and the AI Math/Programming course (MGTA 403) are most frequently chosen as worst. SQL (MGTA 464) and Mkt/Fin/Ops (MGTA 451) sit in the middle. The bootstrap confidence intervals confirm that the top and bottom rankings are statistically reliable, while the middle cluster shows more overlap.
...
np.random.seed(42)
n_iter  = 20000
step    = 0.15   # tuned to ~30% acceptance
K       = 9
beta    = np.zeros(K)
lp      = log_post(beta)
